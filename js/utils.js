...
/* Cola por orden de llegada (FIFO). La operación ya no trabaja
   por prioridad — el que llega primero, se atiende primero. */
function ordenarCola(lista) {
  return [...lista].sort((a, b) => new Date(a.entrada) - new Date(b.entrada));
}
