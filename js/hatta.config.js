...
const HATTA = {
  ...
  ---------------------------------------------------------- */
  MODULOS: [
    { id: 'dashboard', label: 'Dashboard', icono: 'gauge',            color: '#38bdf8' },
    { id: 'garita',    label: 'Garita',    icono: 'scan-face',        color: '#22c55e' },
    { id: 'patio',     label: 'Patio',     icono: 'warehouse',        color: '#f59e0b' },
    { id: 'despacho',  label: 'Despacho',  icono: 'git-pull-request', color: '#a78bfa' },
    { id: 'historial', label: 'Historial', icono: 'history',          color: '#60a5fa' },
    { id: '360',       label: '360',       icono: 'radar',            color: '#2dd4bf' },
    { id: 'maestro',   label: 'Maestro',   icono: 'settings',         color: '#ef4444', soloAdmin: true },
  ],
  modulosPorRol: {
