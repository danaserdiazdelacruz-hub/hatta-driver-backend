...
const HATTA = {
  ...
  /* ----------------------------------------------------------
     2.4 MÓDULOS — unidades de acceso del sistema.
     El Administrador de Acceso (Maestro → Usuarios) asigna
     estos módulos por usuario. null en usuarios.modulos =
     usa los valores por defecto de su rol.
  ---------------------------------------------------------- */
  MODULOS: [
    /* color = decorativo (bordes/tintes) · tinta = texto/iconos
       sobre tema claro (contraste WCAG AA ≥ 4.5:1 sobre #fff)   */
    { id: 'dashboard', label: 'Dashboard', icono: 'gauge',            color: '#38bdf8', tinta: '#075985' },
    { id: 'garita',    label: 'Garita',    icono: 'scan-face',        color: '#22c55e', tinta: '#166534' },
    { id: 'patio',     label: 'Patio',     icono: 'warehouse',        color: '#f59e0b', tinta: '#92400e' },
    { id: 'despacho',  label: 'Despacho',  icono: 'git-pull-request', color: '#a78bfa', tinta: '#6d28d9' },
    { id: 'historial', label: 'Historial', icono: 'history',          color: '#60a5fa', tinta: '#1e40af' },
    { id: '360',       label: '360',       icono: 'radar',            color: '#2dd4bf', tinta: '#0f766e' },
    { id: 'maestro',   label: 'Maestro',   icono: 'settings',         color: '#ef4444', tinta: '#b91c1c', soloAdmin: true },
  ],
  modulosPorRol: {
    admin:   ['dashboard', 'garita', 'patio', 'despacho', 'historial', '360', 'maestro'],
    trafico: ['dashboard', 'garita', 'patio', 'despacho', 'historial', '360'],
    chofer:  [],
  },
  ...
  CATALOGOS: {
    ...
    vehiculos: {
      ...
      campos: [
        ...
        /* `tipo` guarda la TEMPERATURA (Seco/Frío/Termo) — así se usó
           siempre en la BD; solo se corrige la etiqueta que confundía. */
        { key: 'tipo', label: 'Temperatura', tipo: 'lista', opcionesDe: 'config.catUnidad' },
        /* Tipo de vehículo REAL (Rígido, Patana…), alimentado por los
           chips de Catálogos → "Tipo de vehículo". Garita lo usa para
           autocompletar la clasificación. Columna: vehiculos.tipo_vehiculo */
        { key: 'tipo_vehiculo', label: 'Tipo de vehículo', tipo: 'lista', opcionesDe: 'config.catVehiculo' },
    ...
    motivos_rechazo: {
      titulo: 'Motivos de rechazo', singular: 'motivo de rechazo', icono: 'ban',
      storage: 'jsonb',
      campoPrincipal: 'texto',
      ayuda: 'Aparecen como botones de un toque al rechazar un ingreso en Garita.',
      campos: [
        { key: 'texto', label: 'Motivo', tipo: 'texto', requerido: true, unico: true, min: 3 },
      ],
    },
  ...
  supabase: {
    ...
    // ============================================================
    url:     'https://fkujfaqmuuiqdmugpjyp.supabase.co',
    anonKey: 'sb_publishable_WLA08FbUxqtQoxeUr4YNWA_-CBEuCD9',
